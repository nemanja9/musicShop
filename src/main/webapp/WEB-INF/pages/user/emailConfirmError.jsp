        ...
        <div class="container">
            <div class="row">
                <div class="center-email-conf">
                    <img src="${pageContext.request.contextPath}/resursi/images/error.png" alt="" class="potvrdjenEmailSlika">
                    <br>
                    <h2 class="display-3 text-black"><fmt:message key="emailConfError.error"/></h2>         
                    <div class="asdasdasd">
