...
<script src="${pageContext.request.contextPath}/resursi/js/jquery-3.3.1.min.js"></script>
...
<script src="${pageContext.request.contextPath}/resursi/js/jquery.magnific-popup.min.js"></script>
<script src="${pageContext.request.contextPath}/resursi/js/aos.js"></script>
<script src="${pageContext.request.contextPath}/resursi/js/main.js"></script>
