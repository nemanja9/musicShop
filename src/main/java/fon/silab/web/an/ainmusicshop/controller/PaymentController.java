...
public class PaymentController {
    ...
    public ModelAndView paypal(@ModelAttribute(name = "orderDto") OrderDto orderDto, HttpServletRequest request, HttpServletResponse response, HttpSession session)
        ...
        try {
            ...
            System.out.println("APPROVAL LINK JE " + approvalLink);
...
//        OVDE CEMO UBACITI U BAZU PORUDZBINNU KOJA SE UPRAVO ZAVRSILA
        ...
        try {
            mailService.send("musicshopan@gmail.com", order.getUserDto().getEmail(), "Potvrda porudzbine", EmailTemplateGenerator.dajEmailPotvrdaPorudzbine(order));
        } catch (Exception ex) {
